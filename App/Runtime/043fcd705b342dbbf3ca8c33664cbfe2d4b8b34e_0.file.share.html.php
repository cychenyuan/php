<?php
/* Smarty version 3.1.30, created on 2017-02-28 16:11:43
  from "D:\blog\App\home\View\test\share.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58b530bfceac17_62915814',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '043fcd705b342dbbf3ca8c33664cbfe2d4b8b34e' => 
    array (
      0 => 'D:\\blog\\App\\home\\View\\test\\share.html',
      1 => 1488268516,
      2 => 'file',
    ),
  ),
...
function content_58b530bfceac17_62915814 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html>
<head>
...
<div class="ibody">
  ...
  <article>
    ...
    <div class="template">
      ...
      <ul>
        <li><a href="/"  target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/t00.jpg"></a><span>黑色Html5个人博客模板主题《如影随形》</span></li>
        <li><a href="/"  target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/t01.jpg"></a><span>仿新浪博客风格·梅——古典个人博客模板</span></li>
        <li><a href="/" target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/t02.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
        <li><a href="/"  target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/t03.jpg"></a><span>Green绿色小清新的夏天-个人博客模板</span></li>
        <li><a href="/" target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/t04.jpg"></a><span>女生清新个人博客网站模板</span></li>
        <li><a href="/"  target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/t05.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
        <li><a href="/"  target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/t06.jpg"></a><span>Green绿色小清新的夏天-个人博客模板</span></li>
        <li><a href="/"  target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/01.jpg"></a><span>仿新浪博客风格·梅——古典个人博客模板</span></li>
        <li><a href="/" target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/02.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
        <li><a href="/" target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/04.jpg"></a><span>女生清新个人博客网站模板</span></li>
        <li><a href="/"  target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/02.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
        <li><a href="/"  target="_blank"><img src="<?php echo __PUBLIC__;?>
Home/images/03.jpg"></a><span>Green绿色小清新的夏天-个人博客模板</span></li>
      </ul>
      <h3>
